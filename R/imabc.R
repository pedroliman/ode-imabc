...
# This is the backend function that is passed to imabc:
...
b_fun <- function(params, all_parm_names, target_fun, other_inputs) {
  ...
  OUT_put(paste0(json_params, "|", json_lower_bounds, "|", json_upper_bounds))

  # ';' separated list of json maps
  res <- IN_get()

  # This is tightly connected with this line in the imabc_workflow.swift function:
...
# This is the code to run the IMABC algorithm.
